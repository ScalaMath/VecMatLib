...
public class TestVec2d {
    ...
    public void testSumOfTwoVectors() {
        var a = new Vec2d(1.0, 2.0);
        var b = new Vec2d(2.0, 3.0);
        var res = new Vec2d(3.0, 5.0);
        Assert.assertEquals(res, a.plus(b));
    }

    @Test
    public void testSumVectorValues() {
        var v1 = new Vec2d(1.0, 2.0);
        var v2 = v1.plus(2.0, 3.0);
        var res = new Vec2d(3.0, 5.0);
    ...
    public void testSubtractionOfTwoVectors() {
        var a = new Vec2d(3.0, 5.0);
        var b = new Vec2d(2.0, 3.0);
        var res = new Vec2d(1.0, 2.0);
        Assert.assertEquals(res, a.minus(b));
    }

    @Test
    public void testSubtractionVectorValues() {
        var v1 = new Vec2d(3.0, 5.0);
        var v2 = v1.minus(2.0, 3.0);
        var res = new Vec2d(1.0, 2.0);
        Assert.assertEquals(res, v2);
    }
    ...
    public void testNegated() {
        var vec = new Vec2d(1.1, -2.2);
        var res = new Vec2d(-1.1, 2.2);
        Assert.assertEquals(res, vec.negated());
    }

    @Test
    public void testComponentWiseVectorMultiplication() {
        var a = new Vec2d(2.0, 3.0);
        var b = new Vec2d(3.0, 4.0);
        var res = new Vec2d(6.0, 12.0);
        Assert.assertEquals(res, a.multiply(b));
    }

    @Test
    public void testComponentWiseValuesMultiplication() {
        var v1 = new Vec2d(2.0, 3.0);
        var v2 = v1.multiply(3.0, 4.0);
        var res = new Vec2d(6.0, 12.0);
        Assert.assertEquals(res, v2);
    }
    ...
    public void testVectorScalarMultiplication() {
        ...
        var res = new Vec2d(1.5, 3.0);
        Assert.assertEquals(res, v2);
    }

    @Test
    public void testComponentWiseVectorDivision() {
        var a = new Vec2d(6.0, 12.0);
        var b = new Vec2d(3.0, 4.0);
        var res = new Vec2d(2.0, 3.0);
        Assert.assertEquals(res, a.divide(b));
    }

    @Test
    public void testComponentWiseValuesDivision() {
        var v1 = new Vec2d(6.0, 12.0);
        var v2 = v1.divide(3.0, 4.0);
        var res = new Vec2d(2.0, 3.0);
        Assert.assertEquals(res, v2);
    }
    ...
    public void testVectorScalarDivision() {
        ...
        var res = new Vec2d(0.5, 1.0);
        Assert.assertEquals(res, v2);
    }

    @Test
    public void testComponentWiseVectorMod() {
        var a = new Vec2d(1.0, 8.0);
        var b = new Vec2d(2.0, 3.0);
        var res = new Vec2d(1.0, 2.0);
    ...
    public void testComponentWiseValuesMod() {
        var v1 = new Vec2d(1.0, 8.0);
        var v2 = v1.mod(2.0, 3.0);
        var res = new Vec2d(1.0, 2.0);
        Assert.assertEquals(res, v2);
    }
    ...
    public void testVectorEqualsTwoValues() {
        var vec = new Vec2d(1.1, 2.2);
        Assert.assertTrue(vec.equals(1.1, 2.2));
    }

    @Test
    public void testVectorEqualsApproxTwoValues() {
        var vec = new Vec2d(1.0, 2.0);
        Assert.assertTrue(vec.equalsApprox(0.99999999, 1.99999999));
    }

    @Test
    public void testVectorEqualsApproxVector() {
        var v1 = new Vec2d(1.0, 2.0);
        var v2 = new Vec2d(0.99999999, 1.99999999);
