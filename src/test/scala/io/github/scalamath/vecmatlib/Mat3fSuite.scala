...
class Mat3fSuite extends AnyFunSuite {
  ...
  test("2x3 submatrix") {
    val m = Mat3f(1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f)
    assert(m.submatrix(0) == Mat2x3f(4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f))
    assert(m.submatrix(1) == Mat2x3f(1.0f, 2.0f, 3.0f, 7.0f, 8.0f, 9.0f))
    assert(m.submatrix(2) == Mat2x3f(1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f))
  ...
  test("Rotation matrix around the x axis") {
    ...
    val m = Mat3f.rotationX(math.Pi / 4.0)
    assert(m * v1 === v2)
  }
  ...
  test("Rotation matrix around the y axis") {
    ...
    val m = Mat3f.rotationY(math.Pi / 4.0)
    assert(m * v1 === v2)
  }
  ...
  test("Rotation matrix around the z axis") {
    ...
    val m = Mat3f.rotationZ(math.Pi / 4.0)
    assert(m * v1 === v2)
  }
  ...
  test("Rotation matrix around the three axes") {
    ...
    val m = Mat3f.rotation(math.Pi / 3.0, math.Pi / 4.0, math.Pi / 6.0)
    assert(m * v1 === v2)
  }
  ...
  test("Rotation around an arbitrary axis") {
    ...
    val matrix = Mat3f.rotation(axis, math.Pi / 4.0)
  ...
  test("Rotation matrix from quaternion") {
    ...
    val matrix = Mat3f.rotation(quaternion)
    val point = Vec3f(1.0f, 2.0f, 1.0f)
