...
case class Vec3f(x: Float, y: Float, z: Float) {
   ...
   * @return The dot product between this vector and the given values.
   */
  def dot(v: Vec2f, z: Float): Float = this.dot(v.x, v.y, z)
   ...
   */
  def bezierInterpolate(to: Vec3f, control: Vec3f, t: Float): Vec3f = Vec3f(
   ...
   */
  def bezierDerivative(to: Vec3f, control: Vec3f, t: Float): Vec3f = Vec3f(
   ...
   */
  def bezierInterpolate(to: Vec3f, control1: Vec3f, control2: Vec3f, t: Float): Vec3f = Vec3f(
   ...
   */
  def bezierDerivative(to: Vec3f, control1: Vec3f, control2: Vec3f, t: Float): Vec3f = Vec3f(
