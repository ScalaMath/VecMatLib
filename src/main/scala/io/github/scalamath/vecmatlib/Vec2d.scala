...
case class Vec2d(x: Double, y: Double) {
   ...
   */
  def bezierInterpolate(to: Vec2d, control: Vec2d, t: Double): Vec2d = Vec2d(
   ...
   */
  def bezierDerivative(to: Vec2d, control: Vec2d, t: Double): Vec2d = Vec2d(
   ...
   */
  def bezierInterpolate(to: Vec2d, control1: Vec2d, control2: Vec2d, t: Double): Vec2d = Vec2d(
   ...
   */
  def bezierDerivative(to: Vec2d, control1: Vec2d, control2: Vec2d, t: Double): Vec2d = Vec2d(
